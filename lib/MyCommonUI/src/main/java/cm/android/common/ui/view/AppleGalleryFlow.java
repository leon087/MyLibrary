...
public class AppleGalleryFlow extends Gallery {
    ...
    public AppleGalleryFlow(Context context) {
        this(context, null);
    }

    public AppleGalleryFlow(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AppleGalleryFlow(Context context, AttributeSet attrs, int defStyle) {
